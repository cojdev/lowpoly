...
var ColourControls = function (_React$Component) {
    ...
    function ColourControls() {
        ...
        var _this = _possibleConstructorReturn(this, (ColourControls.__proto__ || Object.getPrototypeOf(ColourControls)).call(this));
    ...
    _createClass(ColourControls, [{
        ...
        key: 'setActiveColour',
        value: function setActiveColour(e) {
        ...
        key: 'handleChangeColour',
        value: function handleChangeColour(index, hexValue) {
        ...
        value: function handleRgbSet(value, name) {
            ...
            var rgb = colour.hexToRgb(colours[this.state.active]);
            if (name === 'red') {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_Fields.NumberField, {
                            id: 'width',
    ...
    _createClass(Display, [{
        ...
        value: function componentDidUpdate(previousProps, previousState) {
            ...
            if (previousProps.settings !== this.props.settings) {
                ...
                var draw = window.setTimeout(this.drawCanvas.bind(this, canvas, canvas2, function () {
                    console.log('callback');self.refs.loader.style.display = 'none';
                }), 5);
            }
        }
        /**
        ...
        value: function drawCanvas(canvas, canvas2, callback) {
            ...
            var generatePoints = function generatePoints(amount) {
            ...
            var draw = function draw(obj, rand) {

                var red, blue, green, alpha;

                var setColour = function setColour(xpos, ypos) {
                    if (xpos < 0) {
                        xpos = 0;
                    }
                    if (xpos > cvs.width - 1) {
            ...
            // saveImage();
            var outputDataURL = canvas.toDataURL();
        ...
        key: 'render',
        value: function render() {
            var width = this.props.settings.dimensions.width,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(Canvas, {
                    ...
                    width: width,
                    height: height }),
                _react2.default.createElement(HiddenCanvas, {
                    ref: 'canvas2',
                    width: width,
                    height: height })
            );
				...
				_createClass(Header, [{
								...
								value: function render() {
												return _react2.default.createElement(
																...
																_react2.default.createElement(
																				'a',
																				{ className: 'github-button', href: 'https://github.com/cojdev/lowpoly', 'data-icon': 'octicon-star', 'data-show-count': 'true', 'aria-label': 'Star cojdev/lowpoly on GitHub' },
																				'Star'
																)
												);
								}
...
var rgbToHex = exports.rgbToHex = function rgbToHex(arr) {
    var ret = '#';
    var components = arr.map(function (item) {
        var ret = item.toString(16);
        if (ret.length === 1) {
            ret = '0' + ret;
        }
        return ret;
...
/***/ "./src/js/widgets/ControlGroup.jsx":
/*!*****************************************!*\
  !*** ./src/js/widgets/ControlGroup.jsx ***!
  \*****************************************/
/*! no static exports found */
...
var ControlGroup = function (_React$Component) {
    ...
    function ControlGroup() {
        ...
        var _this = _possibleConstructorReturn(this, (ControlGroup.__proto__ || Object.getPrototypeOf(ControlGroup)).call(this));
